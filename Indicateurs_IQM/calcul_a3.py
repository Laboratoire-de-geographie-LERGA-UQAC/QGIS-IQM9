...
class IndiceA3(QgsProcessingAlgorithm):
    ...
    def processAlgorithm(self, parameters, context, model_feedback):
        ...
        source_vlayer = self.parameterAsVectorLayer(
            parameters, "stream_network", context
        )
        ...
        outputs["ReducedLanduse"] = processing.run(
        ...
        for feature in source.getFeatures():
            ...
            # materialize segment
            single_segment = source.materialize(
            ...
            outputs["damBuffer"] = processing.run(
                "native:buffer",
                alg_params,
                context=context,
                feedback=feedback,
            ...
            outputs["buffer_clip"] = processing.run(
                "native:clip",
                alg_params,
                context=context,
                feedback=feedback,
            ...
            feature_mean_width = ptrefs_mean_width(
                feature, source_vlayer, parameters["ptref_widths"]
            )
            buffer_width = max(
            ...
            outputs["Drain_areaLand_use"] = processing.run(
            ...
            outputs["LanduseUniqueValuesReport"] = processing.run(
            ...
            table = QgsVectorLayer(
                outputs["LanduseUniqueValuesReport"]["OUTPUT_TABLE"], "table", "ogr"
            )
            ...
            feature.setAttributes(feature.attributes() + [indiceA3])
...
def ptrefs_mean_width(
    feature, source, PtRef_id, width_field="Largeur_mod", context=None, feedback=None
):
    expr = QgsExpression(
        f"""
