...
class IndiceF1(QgsProcessingAlgorithm):
    ...
    OUTPUT = "OUTPUT"
    STRUCTURES_PATH = (
        "/home/karim/uqac/indice_F1/data/Structure_tq_shp/gsq_v_desc_strct_tri_rpr.shp"
    )
    FID = "Id"
    ...
    def processAlgorithm(self, parameters, context, model_feedback):
        ...
        for i, feature in enumerate(source.getFeatures()):
            ...
            feature.setAttributes(feature.attributes() + [indiceF1])
    ...
    def shortHelpString(self):
        return self.tr(
            """Calcul de l'indice F1, à partire de la base de donnée des structures issue de \n
...
def gen_buffer(feature, vlayer, context, feedback=None, parameters={}):
    ...
    buffer = processing.run(
        "native:buffer", alg_params, context=context, is_child_algorithm=True
    )["OUTPUT"]
