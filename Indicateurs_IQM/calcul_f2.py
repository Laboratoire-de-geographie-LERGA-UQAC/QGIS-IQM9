...
class IndiceF2(QgsProcessingAlgorithm):
	...
	def initAlgorithm(self, config=None):
		self.addParameter(QgsProcessingParameterMultipleLayers("anthropic_layers", self.tr("Réseau routier (OSM)"), layerType=QgsProcessing.TypeVector, defaultValue=None, optional=True,))
...
def gen_split_normals(points, parameters, width=0, context=None, feedback=None):
	...
	res_id = processing.run("native:mergevectorlayers", alg_params, feedback=feedback, is_child_algorithm=True)['OUTPUT']
